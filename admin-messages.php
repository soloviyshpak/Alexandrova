      ...
      <section class="admin-orders">
        ...
        <ul class="admin-orders__list">
          <li class="admin-orders__item">
            <h4 class="admin-orders__item-title">Сообщение #1</h4>
            <p class="admin-orders__item-info">Имя: Иванов Иван</p>
            ...
            <p class="admin-orders__item-message">
              ...
              Asperiores, placeat corrupti ex alias omnis impedit quaerat unde
              repudiandae excepturi nesciunt libero id, eligendi voluptatum
              architecto dolore corporis molestiae consectetur magni?
            </p>
            <a href="#" class="admin-orders__item-del"
